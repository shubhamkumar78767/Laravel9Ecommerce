...
class FrontendController extends Controller
{
    public function index()
    {
        ...
        $featurdProducts = Product::where('featured','1')->latest()->take(12)->get();
        return view('frontend.index', compact('sliders','trendingProducts','newArrivalProducts','featurdProducts'));
    }
    ...
    public function featuredProducts()
    {
        ...
        return view('frontend.pages.featured-products',compact('featurdProducts'));   
    }
}
