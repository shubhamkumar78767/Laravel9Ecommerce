                ...
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <h5 class="brand-name">
                        <a href="{{url('/')}}" class="text-white text-decoration-none">
                            {{ $appSetting->website_name ?? 'E-Commerce' }}
                        </a>
                    </h5>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('collections/mobile') }}">Mobiles</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('collections/laptops') }}">Laptops</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="{{ url('collections/fashion') }}">Fashion</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('collections/watch') }}">Watches</a>
                    </li>
                </ul>
            </div>
        </div>
